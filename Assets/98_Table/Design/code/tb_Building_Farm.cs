...
namespace Table
{
    public class tb_Building_Farm
    {
        ...
        public static Dictionary<short, tb_Building_Farm> map = new Dictionary<short, tb_Building_Farm>();
        public static List<tb_Building_Farm> list = new List<tb_Building_Farm>();
        public static tb_Building_Farm first = null;

        protected tb_Building_Farm() {}
        public tb_Building_Farm(tb_Building_Farm from)
        {
            this.ID = from.ID;
        ...
        // for loading
        [Serializable]
        class tb_Building_Farm_internal
        {
        ...
        private tb_Building_Farm(tb_Building_Farm_internal from)
        {
            this.ID = from.ID;
            this.QueSlot_Default = from.QueSlot_Default;
            this.QueSlot_Max = from.QueSlot_Max;
        ...
        public static void Load(string json)
        {
            ...
            List<tb_Building_Farm_internal> data = Newtonsoft.Json.JsonConvert.DeserializeObject<List<tb_Building_Farm_internal>>(json, settings);

            foreach (var one in data)
            {
                tb_Building_Farm info = new tb_Building_Farm(one);
                list.Add(info);
        ...
        static void LoadFromSteam(Stream stream)
        {
            ...
            {
                tb_Building_Farm_internal data = new tb_Building_Farm_internal();
                ...
                for (int i = 0; i < count; ++i)
                {
                    ...
                    tb_Building_Farm info = new tb_Building_Farm(data);
                    list.Add(info);
                    map.Add(info.ID, info);
                }
                first = list.Count > 0 ? list[0] : null;
        ...
        public static tb_Building_Farm Clone(tb_Building_Farm from)
        {
            return new tb_Building_Farm(from);
        }
    }
}

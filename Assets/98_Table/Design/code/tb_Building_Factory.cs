...
namespace Table
{
    public class tb_Building_Factory
    {
        ...
        public static Dictionary<short, tb_Building_Factory> map = new Dictionary<short, tb_Building_Factory>();
        public static List<tb_Building_Factory> list = new List<tb_Building_Factory>();
        public static tb_Building_Factory first = null;

        protected tb_Building_Factory() {}
        public tb_Building_Factory(tb_Building_Factory from)
        {
            this.ID = from.ID;
        ...
        // for loading
        [Serializable]
        class tb_Building_Factory_internal
        {
        ...
        private tb_Building_Factory(tb_Building_Factory_internal from)
        {
            this.ID = from.ID;
            this.QueSlot_Default = from.QueSlot_Default;
            this.QueSlot_Max = from.QueSlot_Max;
        ...
        public static void Load(string json)
        {
            ...
            List<tb_Building_Factory_internal> data = Newtonsoft.Json.JsonConvert.DeserializeObject<List<tb_Building_Factory_internal>>(json, settings);

            foreach (var one in data)
            {
                tb_Building_Factory info = new tb_Building_Factory(one);
                list.Add(info);
        ...
        static void LoadFromSteam(Stream stream)
        {
            ...
            {
                tb_Building_Factory_internal data = new tb_Building_Factory_internal();
                ...
                for (int i = 0; i < count; ++i)
                {
                    ...
                    tb_Building_Factory info = new tb_Building_Factory(data);
                    list.Add(info);
                    map.Add(info.ID, info);
                }
                first = list.Count > 0 ? list[0] : null;
        ...
        public static tb_Building_Factory Clone(tb_Building_Factory from)
        {
            return new tb_Building_Factory(from);
        }
    }
}

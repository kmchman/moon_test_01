...
//----------------------------------------------
Shader "Kirnu/Marvelous/CustomLightingMaster 2" {
		...
		Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Geometry" "RenderType"="Opaque" }
			CGPROGRAM
				...
				fixed4 frag(CL_OUT_WPOS v) : COLOR {
					fixed4 o = fixed4(1,1,1,1);
					#ifdef USE_FOG
						#ifndef USE_DIST_FOG
							o = customLightingSoftFogFrag(v, _FogColor, _FogHeight, _LightTint, _UseLightMap, _LightmapPower, _LightmapColor, _ShadowPower , 1);
						#else
						...
						#endif
					#else
						o = customLightingFrag(v, _LightTint, _UseLightMap, _LightmapPower, _LightmapColor, _ShadowPower, 1);
					#endif

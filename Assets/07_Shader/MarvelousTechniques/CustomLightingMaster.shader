...
//----------------------------------------------
Shader "Kirnu/Marvelous/CustomLightingMaster" {
			...
			CGPROGRAM
				...
				fixed4 frag(CL_OUT_WPOS v) : COLOR {
					fixed4 o = fixed4(1,1,1,1);
						...
						#else
							fixed4 c = customLightingSoftFogFrag(v, _FogColor, _FogHeight, _LightTint, _UseLightMap, _LightmapPower, _LightmapColor, _ShadowPower, _ColorBoost);
							o = lerp(half4(_FogColor,1),c,v.color.w);
							o.a = c.a;
						#endif
					#else
						o = customLightingFrag(v, _LightTint, _UseLightMap, _LightmapPower, _LightmapColor, _ShadowPower, _ColorBoost);
					#endif

...
public class LevelChoose : MonoBehaviour
{
	...
	{
		maxActiveLevelIdx = -1;
		UnityEngine.Debug.Assert(currentLevel && togglesFolder && activeTogglePrefab && inactiveTogglePrefab && nextLevelButton && prevLevelButton && levelFolder, "Wrong initial settings");
	}
